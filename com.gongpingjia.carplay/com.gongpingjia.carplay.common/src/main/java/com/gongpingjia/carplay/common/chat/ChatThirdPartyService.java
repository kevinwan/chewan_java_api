...
public interface ChatThirdPartyService {
     ...
     * 注册聊天用户
     *
     * @param token   授权用户token
     * @param userMap 用户username， password键值对列表
     * @return 返回注册结果信息
     * @throws ApiException
     */
     ...
     *
     * @param token       授权用户token
     * @param groupName   用户群名称
     * @param description 群描述信息
     * @param owner       群主ID
     * @param members     群成员ID列表
     * @return 返回创建结果信息
     * @throws ApiException
     */
     ...
     * @param token    授权Token
     * @param groupId  群组ID
     * @param username 用户名称（对应聊天服务器中的username）
     * @return 返回添加结果信息
     * @throws ApiException
     */
     ...
     *
     * @param token       授权Token
     * @param username    消息发送人员
     * @param groupId     用户组ID
     * @param textMessage Text消息内容
     * @return 返回发送结果
     * @throws ApiException
     */
    ...
    /**
     * 管理员用户向其他的用户发送消息，由adminUser向users群组发送textMessage消息
     *
     * @param token       鉴权Token
