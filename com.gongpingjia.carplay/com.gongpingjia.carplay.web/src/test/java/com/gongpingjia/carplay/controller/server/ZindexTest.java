...
public class ZindexTest {
	...
	// UserActivityController userActivityController = new
	...
	//
	// // 2.5注册
	// userInfoController.register(null, null, null, null, null, null, null,
	// null, null, null);
	//
	// // 2.6 获取品牌
	...
	//
	// // 2.11 车主认证申请
	// userInfoController.applyAuthentication(null, null, null, null, null,
	// null, null);
	//
	// // 2.12(已停用)
	//
	...
	//
	// // 2.38 变更我的信息
	// userInfoController.alterUserInfo(null, null, null, null, null, null,
	// null, null);
	//
	// // 2.39 相册图片上传
