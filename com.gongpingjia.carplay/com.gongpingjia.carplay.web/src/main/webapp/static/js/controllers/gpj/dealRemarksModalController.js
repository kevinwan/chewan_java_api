...
gpjApp.controller('dealRemarksModalController', function ($scope, $rootScope, $modalInstance, gpjService) {

    $scope.record = gpjService.getDeal();
    ...
    $scope.update = function () {
        ...
        $rootScope.loadingPromise = gpjService.postTradeCarNote({
            book_id: $scope.record.trade_car_id,
