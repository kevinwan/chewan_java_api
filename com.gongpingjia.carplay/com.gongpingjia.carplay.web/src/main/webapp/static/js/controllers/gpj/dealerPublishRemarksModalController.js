...
gpjApp.controller('dealerPublishRemarksModalController', function ($scope, $rootScope, $modalInstance, gpjService) {

    $scope.record = gpjService.getDealerPublishInfo();
    ...
    $scope.update = function () {
        ...
        $rootScope.loadingPromise = gpjService.postPromoNote({
            publish_id: $scope.record.publish_id,
